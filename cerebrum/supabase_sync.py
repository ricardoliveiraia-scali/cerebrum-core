...
def sync_content_piece(
    ...
    """Insere uma ideia de conteúdo na fila da Lyra (content_pieces).

    Cria com status 'idea' — sem canal nem sub_agent.
    O Ricardo decide depois o formato e quando produzir.
    """
    sb = get_supabase_client()
